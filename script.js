document.addEventListener('DOMContentLoaded', () => {
    ...
    const state = {
        ...
        'precision-edit': { file: null, userInput: '', engineeredPrompt: '', dimensions: { width: 0, height: 0 }, view: 'upload', maskData: null }
    };
    ...
    const createEngineeredPrompt = (tool, toolState) => {
        ...
        if (tool === 'prompt-edit' || tool === 'precision-edit') { return toolState.userInput + preservationPrompt; }
    ...
    const generateImage = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/edit', {
                ...
                body: JSON.stringify({ image: base64Image, imageName: compressedFile.name, imageType: compressedFile.type, prompt: toolState.engineeredPrompt, width: toolState.dimensions.width, height: toolState.dimensions.height, mask: toolState.maskData }),
            });
            clearInterval(progressInterval);
    ...
    const render = () => {
        ...
        const headers = {
            ...
            'precision-edit': { title: 'Precision Edit', subtitle: 'Draw a mask to edit a specific area.' }
        };
    ...
    function addEventListeners() {
        ...
        if (state.activeTool === 'precision-edit' && toolState.view === 'edit') { setupDrawingCanvas(); }
    }
    ...
    function setupDrawingCanvas() {
        ...
        clearButton.addEventListener('click', () => {
            ...
            state['precision-edit'].maskData = null;
        });
        ...
        generateButton.addEventListener('click', () => {
            ...
            if (hasMask) {
                ...
                state['precision-edit'].maskData = maskCanvas.toDataURL('image/png').split(',')[1];
            } else {
                state['precision-edit'].maskData = null; // No mask drawn
            }
        });
    }
