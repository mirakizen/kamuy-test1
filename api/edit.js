...
export default async function handler(req, res) {
  ...
  try {
    ...
    // --- THIS IS THE FIX ---
    // Create a base payload and conditionally add dimensions.
    // Artify and Prompt Edit NEED dimensions. Removal MUST NOT have them to preserve aspect ratio.
    const payload = {
      input: {
        prompt: prompt,
...
### **Step 2: Update the Frontend (`script.js`) with Master Prompts & New UI**

This file contains the completely rewritten prompt logic and the new, working Artify previews.

**➡️ Copy and paste this second block into your terminal and press Enter:**
        ...
        if (toolState.view === 'upload') {
            ...
            if (state.activeTool === 'prompt-edit') {
                ...
                editControls = `<div class="my-4 space-y-2"><div class="flex flex-wrap items-center gap-4">
                 ...
                 const styles = [
                    { name: 'Anime', prompt: 'masterpiece, anime style, vibrant, detailed, studio ghibli style', img: 'https://storage.googleapis.com/static.fal.ai/static/images/8b072591-c454-4286-a24a-1b57221e7842.jpeg' },
                    { name: 'Cyberpunk', prompt: 'cyberpunk style, neon lights, futuristic city, cinematic lighting, highly detailed', img: 'https://storage.googleapis.com/static.fal.ai/static/images/1e485e50-f831-48d6-a077-0c75402a5e44.jpeg' },
                    { name: 'Van Gogh', prompt: 'in the style of Van Gogh, expressive impasto brushstrokes, vibrant colors', img: 'https://storage.googleapis.com/static.fal.ai/static/images/a0e1b033-a337-4148-a0fd-1481b764b8a4.jpeg' },
                    { name: 'Watercolor', prompt: 'watercolor painting, soft wash, flowing colors, detailed', img: 'https://storage.googleapis.com/static.fal.ai/static/images/a41fb30c-044e-4861-9993-873d100021a1.jpeg'},
                    { name: 'Pop Art', prompt: 'Pop Art style, bold colors, graphic novel aesthetic, halftone dots', img: 'https://storage.googleapis.com/static.fal.ai/static/images/99245142-0325-4c57-a3a8-a5b675661661.jpeg'},
                    { name: 'Sketch', prompt: 'pencil sketch, hand-drawn, monochrome, detailed shading, high contrast', img: 'https://storage.googleapis.com/static.fal.ai/static/images/4295e89a-a82f-4824-85b5-227563f03b5f.jpeg' },
                ];
